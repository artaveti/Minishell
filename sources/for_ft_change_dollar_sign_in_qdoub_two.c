...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   for_ft_change_dollar_sign_in_qdoub_two.c           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: artaveti <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/07 10:49:26 by artaveti          #+#    #+#             */
/*   Updated: 2024/01/07 10:54:18 by artaveti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lib_for_minishell.h"

char	*ft_creat_joined_after_change(char *string, char **splitted_str,
			int quant)
{
...
void	ft_additional_for_creat_joined_first(int *i, int *k, char *string,
			char *joined_after_change)
{
	while (string[*i] == ' ')
	{
