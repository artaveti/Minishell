...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_creat_token_for_heredoc.c                       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: artaveti <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/07 13:56:58 by artaveti          #+#    #+#             */
/*   Updated: 2024/01/07 14:08:14 by artaveti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lib_for_minishell.h"

void	ft_parser_for_heredoc(t_token_list **list,
			t_environment_list *envp_list);
void	ft_parser_fourth_join_w_for_heredoc(t_token_list **list,
			t_environment_list *envp_list);
void	ft_parser_fifth_change_type_for_heredoc(t_token_list **list,
			t_environment_list *envp_list);
...
void	ft_parser_for_heredoc(t_token_list **heredoc_list,
			t_environment_list *envp_list)
{
			...
			t_environment_list *envp_list)
{
	...
	while (tmp != NULL)
	{
		if ((tmp->type == WORD || tmp->type == Q_SINGLE
				|| tmp->type == Q_DOUBLE)
			&& tmp->next != NULL
			&& (tmp->next->type == WORD
