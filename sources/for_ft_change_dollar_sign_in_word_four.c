...
void	ft_additional_for_if_first(char **str_for_dup, char **tmp_str, char **g_exit_status_msh_str, int *result);
void	ft_additional_for_if_second(char **name_and_value, char	**tmp_str, int *result);
