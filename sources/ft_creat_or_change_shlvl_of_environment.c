...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_creat_or_change_shlvl_of_environment.c          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: artaveti <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/13 19:36:47 by artaveti          #+#    #+#             */
/*   Updated: 2024/01/13 19:46:12 by artaveti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lib_for_minishell.h"

int		ft_change_shlvl_to_zero(t_environment_list **list,
			long long long_long_num);
int		ft_change_shlvl_to_num_or_null(t_environment_list **list,
			long long long_long_num);
int		ft_check_is_num_minus(const char *str);
void	ft_additional_for_ft_change_shlvl_to_num_or_null(
			t_environment_list *tmp_list, long long long_long_num);
			...
			t_environment_list **start_of_list)
{
	...
	while (tmp_list != NULL)
	{
		...
		{
			long_long_num = ft_longlong_atoi_for_minishell(
					tmp_list->name_and_value[1]);
		...
		long long long_long_num)
{
	...
	if (long_long_num < 2147483647 && long_long_num > -2147483648)
	{
		...
		else if (long_long_num <= 998 && long_long_num >= 0)
		{
			...
			ft_additional_for_ft_change_shlvl_to_num_or_null(tmp_list,
				long_long_num);
		return (1);
	}
	return (0);
