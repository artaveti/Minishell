...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   for_ft_change_dollar_sign_in_word_one.c            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: artaveti <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/07 10:56:14 by artaveti          #+#    #+#             */
/*   Updated: 2024/01/07 11:02:46 by artaveti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_join_splitted_after_change(char **joined_str, char **first_part,
			char **splitted_dollar)
{
	char	*tmp_joined_str;
	int		i;
