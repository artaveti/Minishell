...
PREFIX 			= $(shell find ${HOME} -name for_readline 2>/dev/null)
...
$(OBJECTS_DIR)/%.o: $(SOURCES_DIR)/%.c $(HEADER_FILES)
	$(CC) $(CFLAGS) -I./for-readline/include $(INC) $(HEADERS_DIR) -c $< -o $@

$(NAME): $(OBJECT_FILES)
	$(CC) $(CFLAGS) $(RDLN) -L./for-readline/lib -I./for-readline/include $(OBJECT_FILES) -o $(NAME)
